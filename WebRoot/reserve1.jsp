...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/js/reserve.js;"></script>
<script type="text/javascript">
	// 验证登录名
	/* $(function() {
		var url = "${ pageContext.request.contextPath }/userComment_reveal.action";
		var param = {"user_code" : "${sessionScope.user}"};
	...
	<div class="footer">
		<div class="top">
			<a href="#" id="one">场地预定</a> <a href="#" id="two">场馆介绍</a> <a
				href="#" id="three">会员评价</a> <a href="#" id="four"><img
			...
			<ul id="lda">
				<li class="show">
					...
					<div class="last">
						<p>
							<span>4月20 (星期五)</span>
							<button onclick="commitComment()">预订</button>
						</p>
						<p>
							<span>4月21 (星期六)</span>
							<button>预订</button>
